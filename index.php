...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Agr0-Connect &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="repanalakshminarayana@gmail.com" style="color:white">repanalakshminarayana@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Agr0-Connect</b></span>
				Agr0-Connect is e-commerce trading platform for Agricultural Purpose...
			</p>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
			                        ...
			                        <div class="3u 12u$(small)">
			                            <input type="radio" id="Signfarmer" name="category" value="1" checked>
			                            <label for="Signfarmer">Farmer</label>
			                        </div>
			                        <div class="3u 12u$(small)">
			                            <input type="radio" id="Signbuyer" name="category" value="0">
			                            <label for="Signbuyer">Buyer</label>
			                        </div>
								</div>
								<div class="row uniform">
									<div class="3u 12u$(small)">
