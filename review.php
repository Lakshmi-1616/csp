<?php
	...
	if(isset($_GET['pid'])) {
		...
		// Handle the case when 'pid' is not set or null
...
<html>
<head>
	<title>Agr0-Connect: Product</title>
	<meta lang="eng">
	<meta charset="UTF-8">
...
<body>
	...
	<section id="main" class="wrapper style1 align-center">
			...
			<center>
				<div class="row uniform">
					<div class="6u 12u$(large)">
						<a href="myCart.php?flag=1&pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;">
							<span class="glyphicon glyphicon-shopping-cart"> AddToCart
						</a>
					</div>
					<div class="6u 12u$(large)">
		...
		<div class="container">
			<p style="font: 20px Times new roman; text-align: left;"></p>
