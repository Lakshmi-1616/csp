		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="Fruit & Vegetables" style="color: black;">Fruit & Vegetables</option>
				...
				<?php
				    ...
				    if(isset($_GET['type']) AND $_GET['type'] == "Fruit & Vegetables")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Fruit & Vegetables'";
					}
